...
try
{
    $ChangelogLines = Get-Content "CHANGELIST.md"
    ...
    $ReleaseNotes += ""
    $ReleaseNotes += "See the [Read Me](./README.md) for installation instructions and the [Changelist](./CHANGELIST.md) for the complete change history."
